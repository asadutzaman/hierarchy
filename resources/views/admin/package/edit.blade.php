...
<div class="container-fluid">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('admin_package.update', $data->id) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <img src="{{ URL::to('/') }}/images/packages/{{ $data->image }}" class="img-thumbnail" width="400" /></br>
