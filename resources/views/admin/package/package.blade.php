...
<div class="container-fluid">
    ...
    <div class="card mb-4">
        ...
        <table class="table table-bordered table-striped">
            ...
            @foreach($data as $row)
            <tr>
                <td><img src="{{ URL::to('/') }}/images/packages/{{ $row->image }}" class="img-thumbnail" width="75" /></td>
                <td>{{ $row->name }}</td>
                <td>{{ $row->price }}</td>
                <td>
                    
                    <form action="{{ route('admin_package.destroy', $row->id) }}" method="post">
                        <a href="{{ route('admin_package.show', $row->id) }}" class="btn btn-outline-success">
                            <i class="fa fa-info-circle" aria-hidden="true"></i>
                        </a>
                        <a href="{{ route('admin_package.edit', $row->id) }}" class="btn btn-outline-warning">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('admin_package.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="col-md-6"><b>Enter package Name:</b></label>
                        <div class="col-md-12">
                            <input type="text" name="name" class="form-control input-lg" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-6"><b>Enter package Price:</b></label>
                        <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label class="col-md-12"><b>Select package Image:</b></label>
                        <div class="col-md-12">
