...
<div class="container-fluid">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('admin_slider.update', $data->id) }}" enctype="multipart/form-data">
            
                @csrf
                @method('PATCH')
                <div class="form-group">
                    <label class="col-md-6"><b>Enter slider Name:</b></label>
                    <div class="col-md-12">
                ...
                <div class="form-group">
                    <label class="col-md-12"><b>Select Slider Image:</b></label>
                    <div class="col-md-12">
                        <img src="{{ URL::to('/') }}/images/sliders/{{ $data->image }}" class="img-thumbnail" width="400" /></br>
