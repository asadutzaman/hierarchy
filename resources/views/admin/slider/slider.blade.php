...
<div class="container-fluid">
    ...
    <div class="card mb-4">
        ...
        <table class="table table-bordered table-striped">
            ...
            @foreach($data as $row)
            <tr>
                <td><img src="{{ URL::to('/') }}/images/sliders/{{ $row->image }}" class="img-thumbnail" width="75" /></td>
                <td>{{ $row->headline }}</td>
                <td>
                    
                    <form action="{{ route('admin_slider.destroy', $row->id) }}" method="post">
                        <a href="{{ route('admin_slider.show', $row->id) }}" class="btn btn-outline-success">
                            <i class="fa fa-info-circle" aria-hidden="true"></i>
                        </a>
                        <a href="{{ route('admin_slider.edit', $row->id) }}" class="btn btn-outline-warning">
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add New Sliders</h5>
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('admin_slider.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="col-md-6"><b>Enter Sliders Name:</b></label>
                        <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label class="col-md-12"><b>Select Sliders Image:</b></label>
                        <div class="col-md-12">
