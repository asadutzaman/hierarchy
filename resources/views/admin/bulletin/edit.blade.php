...
<div class="container-fluid">
    ...
    <li class="breadcrumb-item"> <a href="{{ url('/admin2') }}"> Dashboard</a></li>
        ...
        <li class="breadcrumb-item active">Bulletin Update</li>
    </ol>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('admin_bulletin.update', $data->id) }}" enctype="multipart/form-data">
                ...
                @method('PATCH')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="file"  name="file" value="{{ url('/') }}/bulletin/{{ $data->file }}" class="form-control input-lg">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12"><b>Select cover image:</b></label>
                        <div class="col-md-12">
                            <input type="file"  name="image" value="{{ url('/') }}/images/bulletin/{{ $data->image }}" class="form-control input-lg">
                        </div>
                    </div>
